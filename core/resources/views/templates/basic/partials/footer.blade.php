  ...
  <footer style="background-color: black">>
    <div class="container">
        <div class="footer-bottom">
            ...
            <div class="footer-widget widget-link">
                <h5 class="title cl-white">@lang('Lien utile')</h5>
                <ul>
                    <li><a href="{{route('about_us')}}">@lang('Qui sommes-nous')</a></li>
                    <li><a href="{{route('contact')}}">@lang('Contactez-nous')</a></li>
                    <li><a href="{{route('faqs')}}">@lang('FAQ')</a></li>
                    <li><a href="{{route('order-track')}}">@lang('Suivre votre commande')</a></li>
                </ul>
            </div>

            <div class="footer-widget widget-link widget-contact">
                <h5 class="title cl-white">@lang('Contactez-nous')</h5>
                <ul>
                    <li>
