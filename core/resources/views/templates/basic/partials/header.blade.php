    ...
    <header>
        <div class="header-top py-1 border-bottom-1 d-none d-lg-block" style="background-color: #055f73">>
            <div class="container">
                <div class="header-top-wrap d-flex flex-wrap justify-content-between align-items-center">
                    <div class="right-side">
                        <ul>
                            ...
                            <li><a href="{{route('order-track')}}">@lang('Suivez votre commande')</a></li>
                        </ul>
                    </div>
                    <!--<div class="left-side">
                        <div class="language_setting">
                            <div class="active_lang ">
                                ...
                                @php
                                    $default = $language->where('code', 'fr')->first();
                                @endphp

                                    <div class="img">
                                        <img src="{{ getImage('assets/images/lang' .'/'. $default['icon'],'64x64')}}" alt="@lang('image')">
                                    </div>
                                    <span class="text-capitalize">@lang('French')</span>
                                @else
        ...
        <div class="header-middle bg-white py-3">
            <div class="container">
                <div class="header-wrapper justify-content-between align-items-center">
                    <div class="logo">
                        <a href="{{route('home')}}">
                            <img src="{{ getImage('assets/images/logoIcon/logo1.png', '183x54') }}" alt="@lang('logo')">
                        </a>
                    </div>
                    <ul class="menu ml-auto d-none d-lg-flex">
                        <li>
                            <a href="{{route('home')}}">@lang('menu')</a>
                        </li>

                        <li>
                            <a href="{{ route('products') }}">@lang('Produits')</a>
                        </li>

                        <li>
                            <a href="{{ route('brands') }}">@lang('Marques')</a>
                        </li>
                        <li>
                            <a href="{{ route('contact') }}">@lang('Contactez-nous')</a>
                        </li>
                    </ul>
        ...
        <div class="header-bottom py-3" style="background-color: #055f73">>
            <div class="container">
                <div class="header-bottom-wrapper d-flex flex-wrap justify-content-between align-items-center">
                    ...
                    <form action="{{route('product.search')}}" method="GET" class="header-search-form mr-auto @if(!request()->routeIs('home')) w-100 @endif" >
                        <div class="header-form-group">
                            <input type="text" name="search_key" value="{{request()->search_key}}" placeholder="@lang('Rechercher')...">
                            <button type="submit"><i class="las la-search"></i></button>
                        </div>
                        <div class="select-item">
                            <select class="select-bar" name="category_id">
                                <option selected value="0">@lang('Catégories')</option>
    ...
    <div class="dashboard-menu before-login-menu d-flex flex-wrap justify-content-center flex-column">
        ...
        <div class="login-wrapper py-5 px-4">
            <h4 class="subtitle cl-white">@lang('Mon compte')</h4>
            <form method="POST" action="{{ route('user.login')}}" class="sign-in-form">
                @csrf
                <div class="form-group">
                    <label for="login-username">Nom d'utilisateur</label>
                    <input type="text" class="form-control" name="username" id="login-username" value="{{ old('email') }}" placeholder="@lang('Adresse email')">
                </div>
                <div class="form-group">
                    <label for="login-pass">@lang('Mot de passe')</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="mb-4" name="captcha" autocomplete="off" placeholder="@lang('Enter le code ici')">
                    @lang($captcha)
                </div>
                @endif

                <div class="form-group text-right pt-2">
                    <button type="submit" class="login-button" style="background-color:#d79a10!important">@lang('Connexion')</button>
                </div>

                <div class="pt-2 mb-0">
                    <p class="create-accounts">
                        <a href="{{route('user.password.request')}}" class="mb-2">@lang('Mot de passe oublié ?')?</a>
                    </p>
                    <p class="create-accounts">
                        <span>@lang('Vous n\'avez pas de compte')? <a href="{{route('user.register')}}" class="link-color">@lang('Créer un compte')</a> </span>
                    </p>
                </div>
            </form>
        </div>
