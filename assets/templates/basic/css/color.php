...
.cart-table tr th,
.preloader{ background-color: green!important} a,
...
.owl-dots .owl-dot.active, .captcha{ background-color: #d79a10!important} .link-color,
...
body *::-webkit-scrollbar-thumb{ background-color: <?php echo $color1 ?>!important} *::selection{ background-color: <?php echo $color2 ?>!important} @media (min-width:1200px){ .dashboard-menu.before-login-menu{ background-color: black!important}} .view-number li .bar,
